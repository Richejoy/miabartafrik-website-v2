...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Books | MiabartAfrik.com</title>
		...
		<link href="../assets/css/preloader_miabartAfrik.css" rel="stylesheet">
						...
						<li class="nav-item">
							...
							<ul class="nav-sub">
								<li class="nav-sub-item">
									<a class="nav-sub-link" href="bookcast.html">BookCast</a>
								</li>
								<li class="nav-sub-item">
							              ...
							              <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 form_connexionBookcast login_connexionBookcast pandm">
					                           <div class="form__field">
										        <label for="login__username">
										          <i class="fa fa-map-marker iconBookconnex" data-toggle="tooltip" title="" data-original-title="">
					                        ...
					                        <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 form_connexionBookcast login_connexionBookcast pandm">
					                           <div class="form__field">
										        <label for="login__username">
										          <i class="fe fe-briefcase iconBookconnex" data-toggle="tooltip" title="" data-original-title="">
					                        ...
					                        <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 form_connexionBookcast login_connexionBookcast pandm">
					                           <div class="form__field">
										        <label for="login__username">
										          <i class="fa fa-mars-double iconBookconnex" data-toggle="tooltip" title="" data-original-title="">
									...
									<div class="row" id="graybg"> 
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">
											...
											<div class="booksId">
												...
												<div class="profileImage">
													<img src="../assets/img/artiste/artiste3-1.jpg" alt="team">
												</div>
										...
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">										  
											 <div class="booksId">
												...
												<div class="profileImage">
													<img src="../assets/img/artiste/team-3.jpg" alt="team">
												</div>
						                      	...
						                      	<div class="inner_booksId">
												 	...
												 	<div class="info_booksId">	
							                            ...
							                            <div class="detail-area-header">
															...
															<div class="main_profilbook_header"> 
																<nav class="contact-info">
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Côte d'ivoire"><i class="flag flag-ie"></i></a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="356 392 (Vues)"><i class="fe fe-eye"></i>
																	</a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="5254 (J'aimes)"><i class="fe fe-heart"></i> </a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Inviter"><i class="fe fe-user-plus"></i></a>
										...
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">										  
											 <div class="booksId">
												...
												<div class="profileImage"><img src="../assets/img/artiste/team-4.jpg" alt="team"></div>
						                      	...
						                      	<div class="inner_booksId">
												 	...
												 	<div class="info_booksId">	
							                            ...
							                            <div class="detail-area-header">
															...
															<div class="main_profilbook_header"> 
																<nav class="contact-info">
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Sénégal"><i class="flag flag-sn"></i></a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="356 392 (Vues)"><i class="fe fe-eye"></i>
																	</a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="5254 (J'aimes)"><i class="fe fe-heart"></i> </a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Inviter"><i class="fe fe-user-plus"></i></a>
										...
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">										  
											 <div class="booksId">
												...
												<div class="profileImage"><img src="../assets/img/artiste/team-5.jpg" alt="team"></div>
						                      	...
						                      	<div class="inner_booksId">
												 	...
												 	<div class="info_booksId">	
							                            ...
							                            <div class="detail-area-header">
															...
															<div class="main_profilbook_header"> 
																<nav class="contact-info">
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Mali"><i class="flag flag-ml"></i></a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="356 392 (Vues)"><i class="fe fe-eye"></i>
																	</a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="5254 (J'aimes)"><i class="fe fe-heart"></i> </a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Inviter"><i class="fe fe-user-plus"></i></a>
						                      	...
						                      	<div class="inner_booksId">
												 	...
												 	<div class="info_booksId">	
							                            ...
							                            <div class="detail-area-header">
															...
															<div class="main_profilbook_header"> 
																<nav class="contact-info">
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Nigeria"><i class="flag flag-ng"></i></a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="356 392 (Vues)"><i class="fe fe-eye"></i>
																	</a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="5254 (J'aimes)"><i class="fe fe-heart"></i> </a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Inviter"><i class="fe fe-user-plus"></i></a>
										...
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">										  
											 ...
											 <div class="booksId">
												...
												<div class="profileImage"><img src="../assets/img/artiste/agbodjanTonou.jpg" alt="team"></div>
						                      	...
						                      	<div class="inner_booksId">
												 	...
												 	<div class="info_booksId">	
							                            ...
							                            <div class="detail-area-header">
															...
															<div class="main_profilbook_header"> 
																<nav class="contact-info">
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Caméroun"><i class="flag flag-cm"></i></a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="356 392 (Vues)"><i class="fe fe-eye"></i>
																	</a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="5254 (J'aimes)"><i class="fe fe-heart"></i> </a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Inviter"><i class="fe fe-user-plus"></i></a>
										...
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">										  
											<div class="booksId">
												...
												<div class="profileImage"><img src="../assets/img/artiste/blissful-young.jpg" alt="team"></div>
										...
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">										  
											 <div class="booksId">
												...
												<div class="profileImage"><img src="../assets/img/artiste/studio-dance-photo.jpg" alt="team"></div>
						                      	...
						                      	<div class="inner_booksId">
												 	...
												 	<div class="info_booksId">	
							                            ...
							                            <div class="detail-area-header">
															...
															<div class="main_profilbook_header"> 
																<nav class="contact-info">
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Bourkina-faso"><i class="flag flag-bf"></i></a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="356 392 (Vues)"><i class="fe fe-eye"></i>
																	</a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="5254 (J'aimes)"><i class="fe fe-heart"></i> </a>
																	<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Inviter"><i class="fe fe-user-plus"></i></a>
										...
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">										  
											 <div class="booksId">
												...
												<div class="profileImage"><img src="../assets/img/artiste/pexels-ivan-siarbolin-3841891.jpg" alt="team"></div>
										...
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">										  
											<div class="booksId">
												...
												<div class="profileImage"><img src="../assets/img/artiste/mobola-odukoya.jpg" alt="team"></div>
