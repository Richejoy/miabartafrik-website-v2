...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Votes | MiabartAfrik.com</title>
				...
				<div class="container">
					<div class="inner-body">
						...
						<div class="page-header">
							<div>
								<h2 class="main-content-title tx-24 mg-b-5">Votes</h2>
								<ol class="breadcrumb">
									...
									<div class="row" id="graybg"> 
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">
											...
											<div class="booksId">
												...
												<div class="profileImage">
													<img src="../assets/img/artiste/agbodjanTonou.jpg" alt="team">
												</div>
														...
														<div class="main_profilbook_header"> 
													    	<div class="main-img-user online">
																<a href="book_view.html">
																	<img alt="avatar" class="radius" src="../assets/img/artiste/artiste3-1.jpg">	
																</a> 
															</div> 
										...
										<div class="col-md-6 col-lg-6 col-xl-4 col-sm-6">										  
											 ...
											 <div class="booksId">
												...
												<div class="profileImage"><img src="../assets/img/artiste/3814088.jpg" alt="team"></div>
