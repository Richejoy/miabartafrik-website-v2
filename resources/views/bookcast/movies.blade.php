                ...
                <div class="col-xl-9 col-lg-12">  
                    <div class="content_body"> 
                                    <div class="videoWrapper_miabart_afrik js-videoWrapper_miabart_afrik"> 
                                        ...
                                        <iframe class="videoIframe_miabart_afrik js-videoIframe_miabart_afrik" src="" frameborder="0" allowTransparency="true" allowfullscreen data-src="https://www.youtube.com/embed/Pb0voxno3ZA" allow="autoplay; fullscreen"></iframe>
                                     
                                        <button class="videoPoster_miabart_afrik js-videoPoster_miabart_afrik" style="background-image:url(../assets/img/artiste/home03.jpg);">
                                                    ...
                                                    <div class="item">
                                                        <div class="netconcert_card">
                                                           <div class="videoWrapper_miabart_afrik js-videoWrapper_miabart_afrik"> 
                                                            ...
                                                            <button class="videoPoster_miabart_afrik js-videoPoster_miabart_afrik" style="background-image:url(../assets/img/artiste/black-business.jpg);">
                                                              <svg class="play-vid" viewBox="0 0 100 100">
                                                                <path class="stroke-solid" fill="none" stroke="white" d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
                                                             C97.3,23.7,75.7,2.3,49.9,2.5" />
                                                                <path class="stroke-dotted_miabart_afrik" fill="none" stroke="white" d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
                                                    ...
                                                    <div class="item">
                                                        <div class="netconcert_card">
                                                           <div class="videoWrapper_miabart_afrik js-videoWrapper_miabart_afrik"> 
                                                            ...
                                                            <button class="videoPoster_miabart_afrik js-videoPoster_miabart_afrik" style="background-image:url(../assets/img/artiste/reflex-et-vous.jpg);">
                                                              <svg class="play-vid" viewBox="0 0 100 100">
                                                                <path class="stroke-solid" fill="none" stroke="white" d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
                                                             C97.3,23.7,75.7,2.3,49.9,2.5" />
                                                                <path class="stroke-dotted_miabart_afrik" fill="none" stroke="white" d="M49.9,2.5C23.6,2.8,2.1,24.4,2.5,50.4C2.9,76.5,24.7,98,50.3,97.5c26.4-0.6,47.4-21.8,47.2-47.7
                                                            ...
                                                            <div class="main_profilbook_header"> 
                                                                <div class="main-img-user online">
                                                                    <img alt="avatar" class="radius" src="../assets/img/artiste/LogoBookCast_Reseaux.jpg">  
                                                                </div> 
                                                                <nav class="contact-info">
                                                                    <a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Togo"><i class="flag flag-tg"></i></a>
                                                    ...
                                                    <div class="item">
                                                        <div class="netconcert_card">
                                                           <div class="videoWrapper_miabart_afrik js-videoWrapper_miabart_afrik"> 
                                                            ...
                                                            <div class="all_services_mba"> 
                                                                <small class="all_services_mba_small">Mode & Beauté</small>
                                                                <small class="all_services_mba_small">Interview</small> 
                                                           </div>
