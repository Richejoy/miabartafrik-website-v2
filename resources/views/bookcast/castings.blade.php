...
<html lang="en">
	<head>
		...
		<!-- Title -->
		<title>Castings | MiabartAfrik.com</title>
											            ...
											            <div class="row">
											              ...
											              <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 form_connexionBookcast login_connexionBookcast pandm">
									                        ...
									                        <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 form_connexionBookcast login_connexionBookcast pandm">
									                           <div class="form__field">
														        <label for="login__username">
														          <i class="fa fa-calendar-check-o iconBookconnex" data-toggle="tooltip" title="" data-original-title="">
									...
									<div class="row">
										...
										<div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mb_1_5">
											...
											<div class="castingart_newByOsez">
											  ...
											  <div class="castingart_newByOsez__side castingart_newByOsez__side--front">
											    <div class="castingart_newByOsez__img" style="background-image: url(../assets/img/casting/photography.jpg);">
											    ...
											    <div class="info_container_agendaplus">
													<div class="titre">Séance de shoot photo à l'endroit des modèles photo &amp; mannequin ...</div> 
													<div class="detail-buttons"> 
	                                                   <button class="detail-button">  
	                                                    <a href="castingartview.html">Afficher le casting</a>
	                                                   </button>
													...
													<div class="main_profilbook_header"> 
														<nav class="contact-info">
															<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Afrique-Monde"><i class="fe fe-globe"></i></a>
										...
										<div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mb_1_5">
											...
											<div class="castingart_newByOsez">
											  ...
											  <div class="castingart_newByOsez__side castingart_newByOsez__side--front">
											    <div class="castingart_newByOsez__img" style="background-image: url(../assets/img/casting/work-4.jpg);">
											    ...
											    <div class="info_container_agendaplus">
													<div class="titre">Casting pour des acteurs débutants sur un tournois de court métrage.</div> 
													<div class="detail-buttons"> 
	                                                   <button class="detail-button">  
	                                                    <a href="castingartview.html">Afficher le casting</a>
	                                                   </button>
													...
													<div class="main_profilbook_header"> 
														<nav class="contact-info">
															<a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Côte d'ivoire"><i class="flag flag-ci"></i></a>
										...
										<div class="col-sm-6 col-md-4 col-lg-4 col-xl-4 mb_1_5"> 
											...
											<div class="castingart_newByOsez">
											  ...
											  <div class="castingart_newByOsez__side castingart_newByOsez__side--front">
											    <div class="castingart_newByOsez__img" style="background-image: url(../assets/img/casting/reflex-et-vous.jpg);">											      
											    </div>

											    <h4 class="castingart_newByOsez__text">
											      <span class="castingart_newByOsez__text-span">Photo &amp; Mannequina</span>
											    </h4>
