<div class="partnerArtistik">
    ...
    <div class="main_profilbook_header">
        <nav class="contact-info">
            ...
            <span wire:click.prevent="like({{ $partner->id }})" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="{{ $partner->user->receiverLikes->count() }} (J'aimes)"><i class="fe fe-heart"></i></span>

            <span wire:click.prevent="friend({{ $partner->id }})" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="{{ $partner->user->friends->count() }} (Amis)"><i class="fe fe-user-plus"></i></span>

            @if(Route::currentRouteName() == 'bookcast.networks')
            <a href="{{ $partner->user->call() }}" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Appeler"><i class="fe fe-phone"></i></a>
            @endif

            <span data-show="share-partner{{ $partner->id }}" class="contact-icon border tx-inverse share-partner" data-toggle="tooltip" title="" data-original-title="Publier"><i class="far fa-share-square"></i></span>
        </nav>
    </div>
