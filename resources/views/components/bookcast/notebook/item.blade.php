        ...
        <div class="info_container_agendaplus">
            ...
            <div class="main_profilbook_header">
                <nav class="contact-info">
                    <span class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="{{ $event->user->country->nicename }}"><i class="{{ $event->user->country->getFlag() }}"></i></span>
