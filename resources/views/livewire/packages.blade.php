<section>
    ...
    <div class="col-lg-6 zero_padd">
        <div class="card_prices mb-3">
            <div class="body_price">
                <form method="POST" id="" action="">
                                                                    ...
                                                                    <a href="#" class="avantage text-center" data-show="avantage_price">Voir les avantages <i class="fas fa-chevron-down"></i></a>
        ...
        <a href="#" class="avantage text-center" data-show="avantage_price1">Voir les avantages <i class="fas fa-chevron-down"></i></a>
