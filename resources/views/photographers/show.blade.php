            ...
            <div class="profile_miabartafrik_image">
                <div id="landing-text">
                    <div id="landing-text-inner">
                        <h2>Télécharger notre</h2>
                        <h1>Prospectus</h1>
                        <a href="#pdf book" class="btntelecharger" id="view-work">
                            Télécharger ici
                        </a>
                    </div>
                </div>
                                ...
                                <div class="col-lg-3 eml-mob">
                                    ...
                                    <div class="infos_plus_bookcast">
                                        <ul>
                                            <li>
                                                <div class="desc1">
                                                    <h4>Artistes révélés:</h4>
                                                    <h3>Aamron, BlackT- IGWE, Papou, ...</h3>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="desc1">
                                                    <h4>Evènements organisés</h4>
                                                    <h3>Togocel Plage, La nuit de l'artiste, ...</h3>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="desc1">
                        ...
                        <div class="container_tabs">
                            ...
                            <section>
                                <div class="tabs_miabartafrik tabs_miabartafrik-style-bar">
                                    <nav>
                                        <ul>
                                            <li><a href="#actualite_fiche_reseau"
                                                    class="icon pe-7s-news-paper"><span>Actualités</span></a></li>
                                            <li><a href="#presentation_fiche_reseau"
                                                    class="icon pe-7s-id"><span>Présentation</span></a></li>
                                            <li><a href="#photos_fiche_reseau"
                                                    class="icon pe-7s-camera"><span>Photos</span></a></li>
                                            <li><a href="#artistes_fiche_reseau"
                                                    class="icon pe-7s-users"><span>Artistes</span></a></li>
                                            <li><a href="#grilletarifaire_fiche_reseau"
                                                    class="icon pe-7s-cash"><span>Grille tarifaire</span></a></li>
                                            <li><a href="#contact_fiche_reseau"
                                                    class="icon pe-7s-mail"><span>Contact</span></a></li>
                                        </ul>
                                    </nav>
...
@section('loader')
<x-loader imgLink="{{ $photographer->user->image->link }}" />
@endsection