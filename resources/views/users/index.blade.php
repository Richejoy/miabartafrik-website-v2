...
<html lang="en" dir="ltr">
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="favicon.ico"/>
		 ...
		 <!-- TITLE -->
		<title>Accueil – Plateforme artistique</title>
					...
					<div class="side-tab-body p-0 border-0" id="parentVerticalTab">
						<div class="first-sidemenu">
							<ul class="resp-tabs-list hor_1"> 
								<li class="resp-tab-active active" data-toggle="tooltip" data-placement="right" title="Accueil">
									<div class="slider-text">Accueil</div>
								</li>
								<li data-toggle="tooltip" data-placement="right" title="Book">
					...
					<div class="side-app">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 col-lg-6 col-xl-8">
								...
								<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
									<div class="card borderleft">
										<div class="card-header border-bottom-0">
											<h3 class="card-title font-weight-normal fs-14">CASTINGS</h3>
											 
										</div>
										<div class="card-body">
											<div class="row"> 
												<div class="col">
													<i class="icon icon-note hdicon" data-toggle="tooltip" title="" data-original-title="ion-film-marker"></i>
												</div>
												<div class="col col-auto">
													<h6 class="fs-13 text-muted">Castings partcipés</h6>
													<h3 class="font-rubik mb-0">256</h3>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="card borderleft">
									<div class="card-header border-bottom-0">
										<h3 class="card-title font-weight-normal fs-14">AGENDA+</h3>
										 
									</div>
									<div class="card-body">
										<div class="row"> 
											<div class="col">
												<i class="icon icon-calendar hdicon" data-toggle="tooltip" title="" data-original-title="ion-film-marker"></i>
											</div>
											<div class="col col-auto">
												<h6 class="fs-13 text-muted">Mes évènements</h6>
												<h3 class="font-rubik mb-0">6</h3>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
								<div class="card borderleft">
									<div class="card-header border-bottom-0">
										<h3 class="card-title font-weight-normal fs-14">BOUTIKART</h3>
										 
									</div>
									<div class="card-body">
										<div class="row"> 
											<div class="col">
												<i class="icon icon-handbag hdicon" data-toggle="tooltip" title="" data-original-title="ion-film-marker"></i>
											</div>
											<div class="col col-auto">
												<h6 class="fs-13 text-muted">Nombre d'achat</h6>
												<h3 class="font-rubik mb-0">2</h3>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
								<div class="card borderleft">
									<div class="card-header border-bottom-0">
										<h3 class="card-title font-weight-normal fs-14">PROFIL</h3>
									...
									<div class="card-body pt-0"> 
										<div class="mb-0">
											<p class="mb-2 text-muted">Complèter profil<span class="float-right badge badge-pill badge-secondary">90%</span></p>
