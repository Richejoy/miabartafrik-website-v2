@extends('layouts.user', ['title' => 'Tableau de bord'])
								...
								<div class="card-body p-4">
									<div class="row align-items-center">
										<div class="offset-xl-3 offset-sm-6 col-xl-8 col-sm-6 col-12 img-bg ">
											...
											<p class="tx-white-7 mb-1">Vous avez deux projets à terminer, vous aviez terminé  <b class="text-warning">57%</b> de votre niveau mensuel, continuez à votre niveau
										</div>
										<img src="{{ auth()->user()->library->remote }}" alt="user-img">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-sm-12 col-lg-12 col-xl-4 mt-xl-4">  
					<div class="card custom-card">
						<div class="card-header border-bottom-0 pb-0 d-flex pl-3 ml-1">
							<div>
								<label class="main-content-label mb-2 pt-2">Castings en cours</label>
								<span class="d-block tx-12 mb-2 text-muted">Les castings auxquels vous avez pris part</span>
							</div>
						</div>
						<div class="card-body pt-2 mt-0">
							<div class="list-card mb-0">
								<div class="card-item">  
									<div class="card-item-body">
										<div class="card-item-stat">
											<small class="tx-10 text-primary font-weight-semibold">12 JUIN 2022</small>
											<h6 class=" mt-2">Titre du casting 01</h6>
										</div>
									</div>
								</div>
								<div class="d-flex">
									...
									<div class="ml-auto float-right">
										<div class="">
											...
											<div class="dropdown-menu dropdown-menu-right" style="">
												<a class="dropdown-item" href="#">Voir le casting</a>
												<a class="dropdown-item" href="#">Contact l'annonceur</a> 
											</div>
										</div>
									</div>
								</div> 
							...
							<div class="list-card mb-0">
								<div class="card-item">  
									<div class="card-item-body">
										<div class="card-item-stat">
											<small class="tx-10 text-primary font-weight-semibold">11 JUIN 2022</small>
											<h6 class=" mt-2">Titre du casting 02</h6>
										</div>
									</div>
								</div>
								<div class="d-flex">
