	...
	<body class="app sidebar-mini rtl">
		...
		<div class="page">
					...
					<div class="side-tab-body p-0 border-0" id="parentVerticalTab">
						<div class="first-sidemenu">
							<ul class="resp-tabs-list hor_1"> 
								<li data-toggle="tooltip" data-placement="right" title="Accueil">
									<div class="slider-text">Accueil</div>
								</li>
								<li class="resp-tab-active active" data-toggle="tooltip" data-placement="right" title="Book">
									<div class="slider-text">Book</div>
								</li>
								<li data-toggle="tooltip" data-placement="right" title="Castings">
									<div class="slider-text">Castings</div>
								</li>
								<li data-toggle="tooltip" data-placement="right" title="Réseaux Art">
									<div class="slider-text">Réseaux Art</div>
								</li>
								<li data-toggle="tooltip" data-placement="right" title="Agenda+">
									<div class="slider-text">Agenda+</div>
								</li>
								<li data-toggle="tooltip" data-placement="right" title="NetConcert">
									<div class="slider-text">NetConcert</div>
								</li>
								<li data-toggle="tooltip" data-placement="right" title="BoutikArt">
									<div class="slider-text">BoutikArt</div>
								</li>
								<li data-toggle="tooltip" data-placement="right" title="Bon-Adress">
									<div class="slider-text">Bon-Adress</div>
								</li>
								<li data-toggle="tooltip" data-placement="right" title="Messagerie">
									<div class="slider-text">Messagerie</div>
								</li>
								<li data-toggle="tooltip" data-placement="right" title="Paramètres">
									<div class="slider-text">Paramètres</div>
								</li>
							...
							<div class="second-sidemenu">
								<div class="resp-tabs-container hor_1">
									...
									<div>
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal"><i class="typcn typcn-device-desktop"></i> Accueil</h4>
												<a href="dashboard.html" class="slide-item">Tableau de board</a>
												<a href="www.miabartafrik.com/bookcast" class="slide-item">BookCast</a>
												<a href="www.miabartafrik.com/boutikart" class="slide-item">BoutikArt</a>
												<a href="www.miabartafrik.com/bonadress" class="slide-item">Bon-Adress</a> 

												<div class="card">
													<div class="card-body p-3">
														<div class="d-flex">
															<div class="pr-4 pt-1">
																<i class="icon icon-wallet fs-40 mt-0 text-info"></i>
															</div>
															<div class="">
																<span>Gain(s)</span>
																<h3 class="mb-0">17.845 F.CFA</h3>
															</div>
														</div>
													</div>
												</div>	
									...
									<div class="resp-tab-content-active">
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal"><i class="fa fa-address-card"></i> Book</h4>
												<a href="monbook.html" class="slide-item">Mon Book (profil)</a> 
												<div class="card mt-5">
													<div class="card-body p-3">
														<div class="d-flex">
									...
									<div>
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal"><i class="fa fa-bullhorn"></i> Castings</h4>
												<a href="mes_castings.html" class="slide-item">Mes castings</a> 
										...
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal">
													<i class="fa fa-institution"></i> Réseaux artistiques</h4>
												<a href="mes_réseauxart.html" class="slide-item">Mes réseaux</a> 
									...
									<div>
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal"><i class="fa fa-calendar"></i> Agenda+</h4>
												<a href="mes_events.html" class="slide-item">Mes Evènements</a>
												<a href="mes_tickets.html" class="slide-item">Mes Tickets</a> 
									...
									<div>
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal">
													<i class="fa fa-laptop"></i> NetConcert</h4>

												<a href="concert_venir.html" class="slide-item">Concerts à venir</a> 
												<a href="concert_suivi.html" class="slide-item">Concerts suivi</a>
									...
									<div>
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal"><i class="typcn typcn-calendar-outline"></i> BoutikArt</h4>
												<a href="ma_boutikart.html" class="slide-item">Ma boutikArt</a>
												<a href="mes_ventes.html" class="slide-item">Mes ventes</a>
												<a href="mes_achats.html" class="slide-item">Mes achats</a>

																								 
												<h6 class="text-uppercase mt-6 mb-4">Clients</h6>
												<div class="avatar-list">
													<span><img class="avatar brround mr-2" src="./assets/images/faces/male/1.jpg" alt="img"></span>
													<span><img class="avatar brround mr-2" src="./assets/images/faces/male/2.jpg" alt="img"></span>
													<span><img class="avatar brround mr-2" src="./assets/images/faces/female/1.jpg" alt="img"></span>
													<span class="avatar brround bg-primary">+154</span>
												</div>
											</div>
										</div>
									</div>
									...
									<div>
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal">
													<i class="fa fa-map-marker"></i> Bon-Adress</h4>
												<a href="mes_bonadress.html" class="slide-item">Mes Bon-Adress</a> 
									...
									<div>
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal"><i class="fa fa-envelope-o"></i> Messagerie</h4>
												<a href="messageinbox.html" class="slide-item">Inbox</a> 
											</div>
										</div>
									</div>
									...
									<div>
										<div class="row">
											<div class="col-md-12">
												<h4 class="font-weight-normal"><i class="fa fa-gears"></i> Paramètres</h4>
												<a href="editprofil.html" class="slide-item">Editer profil</a>
												<a href="modifypass.html" class="slide-item">Modifier mot passe</a>
						...
						<div class="container-fluid">
							<div class="d-flex">
								<a class="header-brand d-md-none" href="index.html">
									<img src="./assets/images/brand/logo.png" class="header-brand-img desktop-logo" alt="MiabartAfrik logo">
									<img src="./assets/images/brand/favicon2.png" class="header-brand-img mobile-view-logo" alt="MiabartAfrik logo">
								</a>
								<!-- LOGO -->
								...
								<div class="d-flex order-lg-2 ml-auto header-right-icons header-search-icon">
									...
									<div class="">
										<form class="form-inline">
											<div class="search-element">
												<input type="search" class="form-control header-search" placeholder="Recherche sur MiabartAfrik" aria-label="Search" tabindex="1">
									...
									<div class="dropdown text-center selector profile-1 d-sm-flex d-none">
										<a href="#" data-toggle="dropdown" class="nav-link leading-none d-flex">
											<span><img src="./assets/images/faces/female/16.jpg" alt="profile-user" class="avatar brround cover-image mb-1 ml-0"></span>
										</a>
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">Mon book (Profil)</li>
							</ol>
							<div>
								<a href="#" class="btn btn-sm btn-primary"><i class="ti-settings"></i> Lien page personnelle </a> 
								<a href="#" class="btn btn-sm btn-danger">Activer mon compte </a>
							</div>
						</div>
						<!-- PAGE-HEADER END -->
            ...
            <div class="card-body">
              ...
              <div class="tabs_bookcast_2021 color_tabs_bookcast_20213 icon effect_tabs_bookcast_20218 tabs_tleft">
                <!--TAB 1-->
                <input type="radio" name="tabs" checked="" id="tab1" class="content1">
                <label for="tab1" style="border-left: 0">
                  <span>
                    <span><div class="fa fa-address-card"></div>
                      Editer
                    </span>
                  </span>
                </label>
                ...
                <label for="tab2">
                  <span>
                    <span><div class="fa icon icon-folder-alt"></div>
                      Infos
                    </span>
                  </span>
                </label>
                ...
                <label for="tab3">
                  <span>
                    <span><div class="fa icon icon-camera"></div>
                      Photos
                    </span>
                  </span>
                </label>
                ...
                <label for="tab4">
                  <span><span><div class="fa icon icon-playlist"></div>
                    Audios
                    </span>
                  </span>
                </label>
                <!--TAB 5-->
                <input type="radio" name="tabs" id="tab5" class="content5">
                <label for="tab5">
                  <span><span><div class="fa icon icon-film"></div>
                    Videos
                    </span>
                  </span>
                </label>
                ...
                <ul class="xopbook">
                  ...
                  <!--TAB 2-->
                  <li class="xopli content2">
                    <div> 
                      <p>

                        <!-- content infos-->
               </p><ul class="timeline_bookcast"> 
    
                  <li class="timeline_bookcast-milestone is-current">
                    <div class="timeline_bookcast-action is-expandable expanded">
                      <h2 class="title" tabindex="0" aria-controls="timeline_bookcast-0-milestone-content-0">Biographie</h2>
                      <span class="date">Mise à jour: 14.02.2021</span>
                      <div class="content" id="timeline_bookcast-0-milestone-content-0" role="region" aria-expanded="true">
                        <ul class="liste_infos_book">
                          <li class="biographieActeur"> 

                            <p class="description_artiste">
                            <span class="quote">"</span>
                            Je vous propose donc que nous vous fassions parvenir, par écrit, les données relatives à la proportion et aux quantités concrètes de la pêche industrielle. Vous aurez ainsi tous les chiffres noir sur blanc. C'est, je crois, la solution la plus simple.
                  ...
                  <li class="timeline_bookcast-milestone is-current">
                    <div class="timeline_bookcast-action is-expandable expanded">
                      <h2 class="title" tabindex="0" aria-controls="timeline_bookcast-0-milestone-content-1">Experience</h2>
                      <span class="date">Afficher pour découvrir</span>
                      <div class="content" id="timeline_bookcast-0-milestone-content-1" role="region" aria-expanded="true">
                          <ul class="liste_infos_book ">

                            <!-- CINEMA-->
                              <div class="experiencetypeBookCast">

                                  <div class="experienceBook_titre"> <h4>Théâtre</h4> </div>

                                  <li class="experienceAnneeBox"> 
                                    <div class="datebook">2021</div> 

                                    <div class="experience-box">
                                      <article> 
                                        <div class="experience_titre">VOTRE TITRE ICI</div>
                                                           <!-- 1st line -->
                                                             <div class="label">Auteur</div>  : La biologie   ,
                                         
                                                             <div class="label">Mise en scène</div>  : l'humanité
                                       ...
                                       <!-- 3rd line --> 
                                               ...
                                               <br>
                                                 <div class="label">Lieu de création</div>   : Marché de Wuhan  ,
                                                   <div class="label">Autres lieux</div>  : Tournée mondiale
                                    
                                          <!-- 4th line (ad)--> 
                                         <br>
                                                         <div class="label">Rôle</div>  : Aucun  <br>
                                                     <div class="label">Compagnie</div>  : Collectif on est tous foutus <br>
                                                     <p>Possibilité de prolongation</p>
                              ...
                              <div class="experiencetypeBookCast">
                                  ...
                                  <div class="experienceBook_titre"> <h4>Improvisation</h4> </div>
                              ...
                              <div class="experiencetypeBookCast">
                                  ...
                                  <div class="experienceBook_titre"> <h4>Cinéma</h4> </div>
                              ...
                              <div class="experiencetypeBookCast">
                                  ...
                                  <div class="experienceBook_titre"> <h4>Télévision</h4> </div>
                              ...
                              <div class="experiencetypeBookCast">
                                  ...
                                  <div class="experienceBook_titre"> <h4>Court-métrages</h4> </div>
                              ...
                              <div class="experiencetypeBookCast">
                                  ...
                                  <div class="experienceBook_titre"> <h4>Voix</h4> </div>
                              ...
                              <div class="experiencetypeBookCast">
                                  ...
                                  <div class="experienceBook_titre"> <h4>Publicité / Films industriels &amp; institutionnels</h4> </div>
                              ...
                              <!-- END Publicité / Films industriels & institutionnels-->

                              <!-- Mise en scène-->
                              <div class="experiencetypeBookCast">

                                  <div class="experienceBook_titre"> <h4>Mise en scène</h4> </div>
                              ...
                              <div class="experiencetypeBookCast">
                                  ...
                                  <div class="experienceBook_titre"> <h4>Ecriture</h4> </div>
                              ...
                              <div class="experiencetypeBookCast">
                                  ...
                                  <div class="experienceBook_titre"> <h4>Lecture</h4> </div>
                              ...
                              <div class="experiencetypeBookCast">
                                  ...
                                  <div class="experienceBook_titre"> <h4>Autres prestations</h4> </div>
                  ...
                  <li class="timeline_bookcast-milestone is-current">
                    <div class="timeline_bookcast-action is-expandable expanded">
                      <h2 class="title" tabindex="0" aria-controls="timeline_bookcast-0-milestone-content-2">Parcours</h2>
                      <span class="date">Afficher pour découvrir</span>
                      <div class="content" id="timeline_bookcast-0-milestone-content-2" role="region" aria-expanded="true">
                        <ul class="liste_infos_book"> 
                          <li class="parcourstypeBookCast"> Deuxième parcours ici </li> 
                        </ul>
                      </div>
                    </div>
                  </li>
                  ...
                  <li class="timeline_bookcast-milestone is-current">
                    <div class="timeline_bookcast-action is-expandable expanded">
                      <h2 class="title" tabindex="0" aria-controls="timeline_bookcast-0-milestone-content-3">Caracteristique</h2>
                      <span class="date">Afficher pour découvrir</span>
                      <div class="content" id="timeline_bookcast-0-milestone-content-3" role="region" aria-expanded="true">
                        <ul class="liste_infos_book">
                          <li> Caractéristique sur l'artiste ici </li> 
                        </ul>
                      </div>
                    </div>
                  </li>
                  ...
                  <li class="timeline_bookcast-milestone is-current">
                    <div class="timeline_bookcast-action is-expandable expanded">
                      <h2 class="title" tabindex="0" aria-controls="timeline_bookcast-0-milestone-content-4">Compétences</h2>
                      <span class="date">Afficher pour découvrir</span>
                      <div class="content" id="timeline_bookcast-0-milestone-content-4" role="region" aria-expanded="true">
                        <ul class="liste_infos_book">
                          <li> Les compétences sur l'artiste </li> 
                        </ul>
                      </div>
                    </div>
                  </li>
                  ...
                  <li class="timeline_bookcast-milestone is-current">
                    <div class="timeline_bookcast-action is-expandable expanded">
                      <h2 class="title" tabindex="0" aria-controls="timeline_bookcast-0-milestone-content-5">Agence</h2>
                      <span class="date">Afficher pour découvrir</span>
                      <div class="content" id="timeline_bookcast-0-milestone-content-5" role="region" aria-expanded="true">
                        <ul class="liste_infos_book">
                          <li> L'Agence qui s'occupe de l'artiste ici </li> 
                        </ul>
                      </div>
                    </div>
                  </li>                    
                  ...
                  <!--TAB 3-->
                  <li class="xopli content3">
                    <div> 
                    <p>
                      </p><div class="containergalbook detail-photo-grid">
                   
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/cheerful-girl.jpg">
                              <img src="./assets/images/artiste/cheerful-girl.jpg"></a>
                          </div>
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/black-business.jpg">
                              <img src="./assets/images/artiste/black-business.jpg"></a>
                          </div>
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/blissful-young.jpg">
                              <img src="./assets/images/artiste/blissful-young.jpg"></a>
                          </div>
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/black-woman.jpg">
                              <img src="./assets/images/artiste/black-woman.jpg"></a>
                          </div>
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/home01.jpg">
                              <img src="./assets/images/artiste/home01.jpg"></a>
                          </div>
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/slim-girl.jpg">
                              <img src="./assets/images/artiste/slim-girl.jpg"></a>
                          </div>
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/posing-grey-wall.jpg">
                              <img src="./assets/images/artiste/posing-grey-wall.jpg"></a>
                          </div>
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/Copie de 3766737.jpg">
                              <img src="./assets/images/artiste/Copie de 3766737.jpg"></a>
                          </div>
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/Copie de artiste3.jpg">
                              <img src="./assets/images/artiste/Copie de artiste3.jpg"></a>
                          </div>
                          <div class="grid-item">
                            <a data-fancybox="gallery" href="./assets/images/artiste/Copie de mobola-odukoya.jpg">
                              <img src="./assets/images/artiste/Copie de mobola-odukoya.jpg"></a>
                          </div>
                        </div>
                    <p></p>
                  ...
                  <!--TAB 4-->
                  <li class="xopli content4">
                    <div style="overflow: hidden;">
                       
                    <div class="row">
                      <div class="col-sm-6 col-md-4 col-lg-4 col-xl-6">
                        <!-- AUDIO -->
                           <div id="miabart_audioplayer_bookcast">
                            <div class="detail-photo-title">
                             <i class="fa fa-music" data-toggle="tooltip" title="" data-original-title=""></i>
                             Audios/Musiques
                            </div>
                            ...
                            <div class="infos_audio"> 
                              <span id="typeaudio">Spot radio</span>  <span id="dateaudio">31.03.2021</span> 
                            </div>
                          </div>
							...
							<div class="chat">
								<div class="contacts_card">
									<div class="input-group mb-0 p-3 border-bottom">
										<input type="text" placeholder="Rechercher un nom..." class="form-control search">
									...
									<div class="contacts mb-0">
										<div class="list-group list-group-flush ">
											...
											<div class="list-group-item d-flex  align-items-center">
												<div class="mr-2">
													<span class="avatar brround avatar-md cover-image" data-image-src="./assets/images/faces/female/2.jpg"></span>
												</div>
												<div class="">
											...
											<div class="list-group-item d-flex  align-items-center">
												<div class="mr-2">
													<span class="avatar brround avatar-md cover-image" data-image-src="./assets/images/faces/male/4.jpg"><span class="avatar-status bg-green"></span></span>
												</div>
												<div class="">
											...
											<div class="list-group-item d-flex  align-items-center">
												<div class="mr-2">
													<span class="avatar brround avatar-md cover-image" data-image-src="./assets/images/faces/male/1.jpg"></span>
												</div>
												<div class="">
											...
											<div class="list-group-item d-flex  align-items-center">
												<div class="mr-2">
													<span class="avatar brround avatar-md cover-image" data-image-src="./assets/images/faces/male/2.jpg"><span class="avatar-status bg-green"></span></span>
												</div>
												<div class="">
											...
											<div class="list-group-item d-flex  align-items-center">
												<div class="mr-2">
													<span class="avatar brround avatar-md cover-image" data-image-src="./assets/images/faces/female/5.jpg"><span class="avatar-status bg-green"></span></span>
												</div>
												<div class="">
