...
<html lang="en" dir="ltr">
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="favicon.ico"/>
		 ...
		 <!-- TITLE -->
		<title>Mes paramètres – Plateforme artistique</title>
					...
					<div class="side-tab-body p-0 border-0" id="parentVerticalTab">
						<div class="first-sidemenu">
							<ul class="resp-tabs-list hor_1"> 
								...
								<li class="resp-tab-active active" data-toggle="tooltip" data-placement="right" title="Paramètres">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">EDITER PROFIL</li>
							</ol>
							<div>
