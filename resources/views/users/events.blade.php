...
<html lang="en" dir="ltr">
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="favicon.ico"/>
		 ...
		 <!-- TITLE -->
		<title>Mes évènements – Plateforme artistique</title>
					...
					<div class="side-tab-body p-0 border-0" id="parentVerticalTab">
						<div class="first-sidemenu">
							<ul class="resp-tabs-list hor_1"> 
								...
								<li class="resp-tab-active active" data-toggle="tooltip" data-placement="right" title="Agenda+">
					...
					<div class="side-app">
						...
						<div class="page-header">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active" aria-current="page">MES EVENEMENTS</li>
							</ol>
							<div>
