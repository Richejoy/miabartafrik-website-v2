						...
						<div class="row row-sm">
							<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
								<div class="mt-4 pt-5 p-2 pos-absolute">
									...
									<span class="tx-white-6 tx-13 mb-5 mt-xl-0">Veillez resignez ls champs pour la reinitialisation de votre mot de passe.</span>
								</div>
							</div>
								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											...
											<p class="mb-4 text-muted tx-13 ml-0 text-left">Réinitialiser en quelque seconde votre mot de passe.</p>
											...
											{!! Form::open() !!}
												...
												<div class="form-group text-left"> 
													...
													<input class="form-control" placeholder="Tapez votre mot de passe" type="password">
												</div>
												<div class="form-group text-left">
													<label for="profile_phone" class="required-text mg-b-10 label_mba">
