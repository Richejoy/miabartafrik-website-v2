...
<head>
    <meta charset="UTF-8">
    <title>Complèter Inscription Entrepreneur - Plateforme artistique</title>
                        ...
                        <form action="" method="POST" class="form_connexionBookcast login_connexionBookcast">
                            ...
                            <div class="form__field">
                                <label for="login__username">
                                    ...
                                    <i class="icon icon-graduation iconBookconnex" data-toggle="tooltip" title=""
                                        data-original-title=""></i>
                                    <span class="hidden">Qui?, Quoi? </span></label>
                                <select class="select_on_bookcast">
                                    <option>Qui?, Quoi?</option>
                                </select>
                            </div>
                            ...
                            <div class="form__field">
                                <label for="login__username">
                                    ...
                                    <i class="icon icon-graduation iconBookconnex" data-toggle="tooltip" title=""
                                        data-original-title=""></i>
                                    <span class="hidden">Spécialité</span></label>
                                <select class="select_on_bookcast">
                            ...
                            <div class="form__field">
                                <label for="login__username">
                                    <i class="mdi mdi-account-edit" data-toggle="tooltip" title=""
                                        data-original-title=""></i>
                                    <span class="hidden">Nom société/ Entreprise </span></label>
                                <input autocomplete="username" id="login__username" type="text" name="username"
                                    class="form__input" placeholder="Nom société/ Entreprise" required="">
                            </div>
                            ...
                            <div class="form__field">
                                <label for="login__username">
                                    <i class="mdi mdi-account-edit" data-toggle="tooltip" title=""
                                        data-original-title=""></i>
                                    <span class="hidden">N° CNSS/ NIF </span></label>
                                <input autocomplete="username" id="login__username" type="text" name="username"
                                    class="form__input" placeholder="N° CNSS/ NIF" required="">
                            </div>
                            ...
                            <div class="info_booksId">
                                ...
                                <header class="headerprofilbook">
                                    ...
                                    <div class="titleAndAuthor">
                                        <h2 class="titlebook" title="Nom de l'artiste">
                                            ...
                                            <a href="">Hôtel AHOEFA</a>
                                        </h2>
                                        <address class="book_author">
                                            <a href="/artisteName" class="domaine_artistiqueBookcast">Hôtel</a>
                                        </address>
                                    </div>
                                ...
                                <div class="detail-area-header">
                                    ...
                                    <div class="detail-buttons">
                                        ...
                                        <button class="detail-button">
                                            <a href="bookartisteview.html">Voir la fiche </a>
                                        </button>
                                    </div>
