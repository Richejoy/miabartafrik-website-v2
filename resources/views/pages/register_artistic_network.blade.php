...
<head>
    <meta charset="UTF-8">
    <title>Complèter profil réseau artistique - Plateforme artistique</title>
...
<body>
    ...
    <div id="inscription_Inscrit_bookArt-wrap">
        ...
        <div class="inscription_Inscrit_bookArt-image"
            style="background: url(./assets/images/reseau.jpg) no-repeat center / cover;">
                        ...
                        <form action="" method="POST" class="form_connexionBookcast login_connexionBookcast">
                            ...
                            <div class="form__field">
                                ...
                                <input autocomplete="username" id="login__username" type="text" name="username"
                                    class="form__input" placeholder="Société ou école référente" required="">
                            </div>
                            ...
                            <div class="form__field">
                                <label for="login__username">
                                    ...
                                    <i class="icon icon-symbol-female iconBookconnex" data-toggle="tooltip" title=""
                                        data-original-title=""></i>
