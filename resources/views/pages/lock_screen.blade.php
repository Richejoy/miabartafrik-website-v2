						...
						<div class="row row-sm">
							<div class="col-lg-6 col-xl-5 d-none d-lg-block bg-primary details">
								<div class="mt-4 pt-4 pl-5 ml-3 pr-5 pos-absolute">
									...
									<span class="tx-white-6 tx-13 mb-5 mt-xl-0">Entrez votre mot de passe pour accéder à la plateforme .</span>
								</div>
							</div>
								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body main-profile-overview mt-3 mb-3">
											...
											<p class="mb-4 text-muted tx-13 ml-0 text-left">Déverrouillez votre écran en entrant votre mot de passe</p>
											
											{!! Form::open() !!}
												<div class="text-left d-flex float-left mb-4 user-lock">
													<img alt="avatar avatar-sm" class="rounded-circle mb-0" src="{{ asset('public/assets/img/artiste/artiste3-1.jpg') }}">
													<div class="my-auto">
														<p class="font-weight-semibold my-auto ml-2 text-uppercase ">Fidèle Amouzou</p>
													</div>
												</div>
												<div class="form-group">
													<input class="form-control" placeholder="Tapez votre mot de passe" type="password" id="password" name="password" required>
												</div>
												<div class="text-left">
												...
												<button class="btnSignin ripple btn-main-primary btn-block mt-4" type="submit">Ouvrir</button>
											{!! Form::close() !!}

											<div class="text-left mt-4 ml-0">
												<p class="mb-0">Se connecter avec un autre compte ? <a href="{{ route('page.logout') }}">Se déconnecter</a></p>
											</div>
