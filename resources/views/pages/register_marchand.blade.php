...
<head>
    <meta charset="UTF-8">
    <title>Complèter inscription BoutikArt - Plateforme artistique</title>
...
<body>
    ...
    <div id="inscription_Inscrit_bookArt-wrap">
        ...
        <div class="inscription_Inscrit_bookArt-image"
            style="background: url(./assets/images/shopping-concept.jpg) no-repeat center / cover;">
                            ...
                            <div class="form__field">
                                <label for="login__username">
                                    ...
                                    <i class="icon icon-graduation iconBookconnex" data-toggle="tooltip" title=""
                                        data-original-title=""></i>
                                    <span class="hidden">Type de vente</span></label>
                                <select class="select_on_bookcast">
                                    <option>Que vendez-vous?</option>
                                </select>
                            </div>
