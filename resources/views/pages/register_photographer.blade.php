...
<head>
    <meta charset="UTF-8">
    <title>Complèter Inscription Photographe - Plateforme artistique</title>
...
<body>
    ...
    <div id="inscription_Inscrit_bookArt-wrap">
        ...
        <div class="inscription_Inscrit_bookArt-image"
            style="background: url(./assets/images/photography.jpg) no-repeat center / cover;">
                        ...
                        <form action="" method="POST" class="form_connexionBookcast login_connexionBookcast">
                            ...
                            <div class="form__field">
                                ...
                                <input autocomplete="username" id="login__username" type="file" name="username"
                                    class="form__input" placeholder="Logo de profile" required="">
                            </div>
                            ...
                            <div class="form__field">
                                <label for="login__username">
                                    <i class="mdi mdi-account-edit" data-toggle="tooltip" title=""
                                        data-original-title=""></i>
                                    <span class="hidden">Nom photographe / Studio </span></label>
                                <input autocomplete="username" id="login__username" type="text" name="username"
                                    class="form__input" placeholder="Nom photographe / Studio" required="">
                            </div>
                            ...
                            <div class="form__field">
                                ...
                                <input autocomplete="username" id="login__username" type="text" name="username"
                                    class="form__input" placeholder="N° RCCM" required="">
                            </div>
                            ...
                            <div class="form__field">
                                <label for="login__username">
                                    ...
                                    <i class="icon icon-graduation iconBookconnex" data-toggle="tooltip" title=""
                                        data-original-title=""></i>
                                    <span class="hidden">Statut </span></label>
                            ...
                            <div class="form_steps_option-row animated bounceInDown">
                                <p> Vos spécialités du métier de photographe : </p>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <ul>
                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">paysages</div>
                                            </li>

                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">Portrait</div>
                                            </li>

                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">Animaliers</div>
                                            </li>

                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">Mode</div>
                                            </li>

                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">Culinaires</div>
                                            </li>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">Sportifs</div>
                                            </li>
                                            ...
                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">Rue</div>
                                            </li>

                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">Mariage</div>
                                            </li>

                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">Bébé</div>
                                            </li>

                                            <li>
                                                <input class="inputbookcast2021" id="c1" type="checkbox">
                                                <div for="c1" class="labeloption">Autres...</div>
                                            </li>
                ...
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-5 animated bounceInDown">
                    ...
                    <div class="booksId">
                        ...
                        <div class="profileImage">
                            <img src="./assets/images/artiste/photographprofil.jpg" alt="Photo de profile">
                        </div>
                            ...
                            <div class="info_booksId">
                                ...
                                <header class="headerprofilbook">
                                    <a href="/artisteName" class="ambassadeurSign" style="display: none;">
                                        <img src="./assets/images/icons/iconambassadeur.png" alt="ambassadeur BookCast"
                                    ...
                                    <div class="titleAndAuthor">
                                        <h2 class="titlebook" title="Nom de l'artiste">
                                            ...
                                            <a href="">Votre nom de photographe</a>
                                        </h2>

                                        <address class="book_author">
                                            <a href="/artisteName" class="domaine_artistiqueBookcast">Photographe de
                                                plateau</a>
                                        </address>
                                    </div>
                                </header>
