                                    ...
                                    <div class="main-contact-info-header">
                                        <div class="media">
                                            <div class="main-img-user">
                                                <img alt="avatar" src="../assets/img/artiste/partner.jpg">
                                            ...
                                            <div class="media-body">
                                                <div class="main_book_name">
                                                    <h6>
                                                        <a href="book_view.html">Nom du réseau art</a>
                                                    ...
                                                    <div class="infopartner">
                                                        ...
                                                        <div class="all_services_mba">
                                                            <small class="all_services_mba_small">Télévision</small>
                                                            <small class="all_services_mba_small">Radio</small>
                                                            <small class="all_services_mba_small">Publicité</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <nav class="contact-info">
                                                    ...
                                                    <a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Inviter">
                                                        <i class="fe fe-user-plus"></i>
                                                    </a>
                                                    <a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Publier">
                                                        <i class="far fa-share-square"></i>
                                                    </a>
                                                    <a href="#" class="contact-icon border tx-inverse" data-toggle="tooltip" title="" data-original-title="Bloquer">
                                        ...
                                        <div class="main-contact-action btn-list pt-3 pr-3">
                                            <a href="#" class="btn ripple btn-primary text-white btn-icon" data-placement="top" data-toggle="tooltip" title="" data-original-title="Editer Profile">
                                                <i class="fe fe-edit"></i>
                                            </a>
                                            <a href="#" class="btn ripple btn-secondary text-white btn-icon" data-placement="top" data-toggle="tooltip" title="" data-original-title="Supprimer Profile">
                                ...
                                <div class="tabs_miabartafrik tabs_miabartafrik-style-bar">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="#photos_fiche_reseau" class="icon si si-control-play"><span>Médias</span></a></li>
                                                                                    ...
                                                                                    <div>
                                                                                        <ul class="icons-list">
                                                                                            <li class="icons-list-item icons_recharge">
                                                                                                <i class="si si-emotsmile" data-toggle="tooltip" title="" data-original-title="Ajouter emotsmile"></i>
                                                                                            </li>

                                                                                            <li class="icons-list-item icons_recharge">
                                                                                                <i class="si si-camera" data-toggle="tooltip" title="" data-original-title="Ajouter une photo"></i>
                                                                                            </li>

                                                                                            <li class="icons-list-item icons_recharge">
                                                                                                <i class="si si-social-youtube" data-toggle="tooltip" title="" data-original-title="Ajouter une vidéo"></i>
                                                                                            </li>

                                                                                            <li class="icons-list-item icons_recharge">
                                                                                                <i class="si si-music-tone-alt" data-toggle="tooltip" title="" data-original-title="Ajouter un audio"></i>
                                                                                            </li>
                                                                        ...
                                                                        <div class="card mg-b-20 border">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <p class="post_text mg-t-0">
                                                                                    Un exemple de l'affichage de video
                                                                                    <span>Youtube</span>
                                                                                    mise en ligne via un
                                                                                    <a href="">#URL</a>.
                                                                                </p>
                                                                                <div class="row row-sm">
                                                                                    <div class="container">
...
@section('loader')
<x-loader imgLink="{{ $partner->user->library->remote }}" />
@endsection