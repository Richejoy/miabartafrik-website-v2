<div class="mb-1 navbar navbar-expand-lg  responsive-navbar navbar-dark d-sm-none">
    <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
        <div class="d-flex order-lg-2 ml-auto">
            ...
            <div class="dropdown d-flex" style="display: none !important;">
                ...
                <div class="dropdown-menu dropdown-menu-right  dropdown-menu-arrow">
                    <div class="dropdown-item p-4 bg-image-2 text-center">
                        <h4 class="user-semi-title mb-0 font-weight-bold">3 Nouveaux <span
            ...
            <div class="dropdown d-flex">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                    <div class="dropdown-item p-4 bg-image-3 text-center">
                        <h4 class="user-semi-title mb-0 font-weight-bold">4 Nouveaux <span
                    ...
                    <a href="#" class="dropdown-item d-flex mt-2 pb-3">
                        <div class="avatar avatar-md brround mr-3 d-block cover-image"
                            data-image-src="{{ asset('public/assets/images/faces/male/41.jpg') }}">
                    ...
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <div class="avatar avatar-md brround mr-3 d-block cover-image"
                            data-image-src="{{ asset('public/assets/images/faces/female/1.jpg') }}">
                    ...
                    <a href="#" class="dropdown-item d-flex pb-3">
                        <div class="avatar avatar-md brround mr-3 d-block cover-image"
                            data-image-src="{{ asset('public/assets/images/faces/female/18.jpg') }}">
            ...
            <div class="dropdown text-center selector profile-1 mt-4">
                <a href="#" data-toggle="dropdown" class="nav-link leading-none d-flex">
                    <span><img src="{{ asset('public/assets/images/faces/female/16.jpg') }}" alt="profile-user"
            ...
            <div class="dropdown text-center selector profile-1 mt-4">
                <div class="cmbp-mega-menu-top">
                    <a class="login" href="connexion.html">Me connecter
                        <i class="icon icon-login" data-toggle="tooltip" title=""></i>
                    </a>
                    <a class="register" href="register.html">M'inscrire
                        <i class="icon icon-user-follow" data-toggle="tooltip" title=""></i>
                    </a>
                </div>
