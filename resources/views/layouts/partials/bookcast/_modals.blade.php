...
<div class="modal" id="ticket_event">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Titre de l'évènement ici</h6>
            ...
            <div class="modal-body">
                <div class="row row-sm">
                    <div class="col-md-6">
                        <p>Tickets + prix ici</p>
                    </div>
                    <div class="col-md-6">
                        <p>Formulaire de paiement ici</p>
                        <p>Formulaire de paiement ici</p>
                    </div>
                </div>
...
<div class="modal" id="affiche_modal">
    <div class="modal-dialog_affiche" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Affiche évènement</h6>
                <button aria-label="Close" class="close" data-dismiss="modal" type="button">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
