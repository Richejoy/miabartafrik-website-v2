                        ...
                        <div class="contacts mb-0">
                            <div class="list-group list-group-flush ">
                                <div class="list-group-item d-flex  align-items-center">
                                    <div class="mr-2">
                                        <span class="avatar  brround avatar-md cover-image"
                                            data-image-src="{{ asset('public/assets/images/faces/female/1.jpg') }}"><span
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    <div class="mr-2">
                                        <span class="avatar brround avatar-md cover-image"
                                            data-image-src="{{ asset('public/assets/images/faces/female/2.jpg') }}"></span>
                                    </div>
                                    <div class="">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    <div class="mr-2">
                                        <span class="avatar brround avatar-md cover-image"
                                            data-image-src="{{ asset('public/assets/images/faces/male/4.jpg') }}"><span
                                                class="avatar-status bg-green"></span></span>
                                    </div>
                                    <div class="">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    <div class="mr-2">
                                        <span class="avatar brround avatar-md cover-image"
                                            data-image-src="{{ asset('public/assets/images/faces/female/3.jpg') }}"><span
                                                class="avatar-status bg-green"></span></span>
                                    </div>
                                    <div class="">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    <div class="mr-2">
                                        <span class="avatar  brround avatar-md cover-image"
                                            data-image-src="{{ asset('public/assets/images/faces/female/4.jpg') }}"><span
                                                class="avatar-status bg-green"></span></span>
                                    </div>
                                    <div class="">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    <div class="mr-2">
                                        <span class="avatar brround avatar-md cover-image"
                                            data-image-src="{{ asset('public/assets/images/faces/male/1.jpg') }}"></span>
                                    </div>
                                    <div class="">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    <div class="mr-2">
                                        <span class="avatar brround avatar-md cover-image"
                                            data-image-src="{{ asset('public/assets/images/faces/male/2.jpg') }}"><span
                                                class="avatar-status bg-green"></span></span>
                                    </div>
                                    <div class="">
                                ...
                                <div class="list-group-item d-flex  align-items-center">
                                    <div class="mr-2">
                                        <span class="avatar brround avatar-md cover-image"
                                            data-image-src="{{ asset('public/assets/images/faces/female/5.jpg') }}"><span
                                                class="avatar-status bg-green"></span></span>
                                    </div>
                                    <div class="">
