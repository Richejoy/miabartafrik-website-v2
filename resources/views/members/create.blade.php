@extends('layouts.auth', ['title' => $member->user->full_name])
                ...
                <div class="row row-sm m-0">
                    <div class="col-lg-6 col-xl-5 d-none d-lg-block text-center details">
                        <div class="pt-5 p-2">
                            ...
                            <img src="{{ $member->user->library->remote }}" class="ht-100 mb-0 avatar_inscription" alt="{{ $member->user->library->description }}">
                        ...
                        <div class="log_mba">
                            <div class="card-body p-1">
                                <div class="head_fixed_mba_connex">
                                    ...
                                    <div class="clearfix"></div>
                                    <h5 class="textSignHead">Profession</h5>
                                    <p class="text-muted tx-13 m-0">Sélectionner votre profession.</p>
                                </div>

                                <div id="content-3" class="custom-scrollbar-js">
                                    
                                    <x-auth.member-next-form :member="$member" />
